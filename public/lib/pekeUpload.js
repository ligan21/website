    ...
    $.fn.pekeUpload = function(options) {
        ...
        var pekeUpload = {
            ...
            selectfiles: function() {
                this.obj.click();
                this.id = this.obj[0].attributes["id"].value;
                console.log(this.id);
                //alert(this.obj);
                //alert(this.obj[0].attributes["id"].value);

            },
            handlebuttonevents: function() {
                //this.dofun();
                $(document).on("change", this.obj,
                    function() {
                        //if (!this.id || !this.obj) {
                        //    return;
                        // }
                        //alert(pekeUpload.id);
                        console.log(pekeUpload.obj);
                        //alert(this.obj[0].attributes["id"].value);
                        if (pekeUpload.id == pekeUpload.obj[0].attributes["id"].value) {
            ...
            /*
                        dofun: function (obj,id) {
                            alert(obj);
                            alert(id);
                            alert(obj[0].attributes["id"].value);
                            if (this.id == obj[0].attributes["id"].value) {
                                pekeUpload.checkFile(pekeUpload.obj[0].files[0]);
                                id = "";
                            }
                        },
